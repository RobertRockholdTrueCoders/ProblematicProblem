...
namespace ProblematicProblem
{
    class Program
    {
        ...
        static List<string> _activities = new List<string>() { "Movies", "Paintball", "Bowling", "Lazer Tag", "LAN Party", "Hiking", "Axe Throwing", "Wine Tasting" };
        ...
        static void Main(string[] args)
        {
            ...
            { 
               ...
               int randomNumber = rng.Next(_activities.Count);
               ...
               if (userAge < 21 && randomActivity == "Wine Tasting") 
               {
                    ...
                    Console.WriteLine();
                    _cont = (Console.ReadLine().ToLower() == "redo") ? true : false;
            }
        }
    }
}